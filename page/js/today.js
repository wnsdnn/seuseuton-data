...
const renderCalendar = () => {
  ...
  // year-month 채우기
  document.querySelector('.year-month-day').textContent = `${viewYear}년 ${viewMonth + 1}월 ${viewDay}일`;
  document.querySelector('#year-month-day2').textContent = `${viewYear}년 ${viewMonth + 1}월 ${viewDay}일`;
